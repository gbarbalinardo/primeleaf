...
This manuscript was prepared with substantial assistance from an AI system (Claude,
Anthropic), which contributed to drafting, computation, and verification under the
author's direction; the author takes full responsibility for the content. All
quantitative claims are independently reproducible from the accompanying code
