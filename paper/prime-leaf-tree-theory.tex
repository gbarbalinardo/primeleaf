...
$\frac1T \int_0^T \log|P(\sigma+it) - \tfrac14|\, dt \to \Phi(\sigma)$. Convexity of
$\Phi$ is inherited from the finite-$T$ means, which are convex in $\sigma$ because
$\log|P - \tfrac14|$ is subharmonic.
